...
HWND createWindow(int width, int height) {
	...
	HWND hwnd = CreateWindow("eglsamplewnd", "EGL OpenGL ES 2.0 example", style, CW_USEDEFAULT, CW_USEDEFAULT, rect.right - rect.left, rect.bottom - rect.top, NULL, NULL, GetModuleHandle(NULL), NULL);
